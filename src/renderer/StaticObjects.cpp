...
{
    for (objectlist_t::iterator iter = objectlist.begin(), iterend = objectlist.end(); iter !=
iterend; ++iter) { if (!TestObject(object, *iter)) { objectlist.insert(iter, object); return;
        }
    }
