...
#include <cstdlib>  // doc: malloc and free
#include <cstring>
#include <iostream>
...
UOMapLoader::UOMapLoader( const char* mapfile, const char* staticfile, const char* staidx,
                          int widthblocks, int heightblocks )
{
  mapstream = new ifstream( mapfile, ios::in | ios::binary );
  if ( !mapstream )
  {
    pDebug.Log( "Out of Memory in UOMapLoader::UOMapLoader(char *, char * , char *, int)", __FILE__,
  ...
  if ( !mapstream->is_open() )
  {
    ...
    pDebug.Log( "Map load error in UOMapLoader::UOMapLoader(char *, char * , char *, int)",
  ...
  {
    printf( "While loading %s: \n", staticfile );
    pDebug.Log( "Static load error in UOMapLoader::UOMapLoader(char *, char * , char *, int)",
                __FILE__, __LINE__, LEVEL_ERROR );
    return;
  }
  ...
  {
    printf( "While loading %s: \n", staidx );
    pDebug.Log( "Static index load error in UOMapLoader::UOMapLoader(char *, char * , char *, int)",
                __FILE__, __LINE__, LEVEL_ERROR );
    return;
  }
